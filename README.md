...
PHP uses the system supplied CURL library. Version 7.34.0 or later is required. You may also need to update SSL/TLS libraries, see [here](http://curl.haxx.se/docs/ssl-compared.html) for more details.
...
> **Note:** Please make sure that your command line test is finding the same versions of PHP & SSL/TLS libraries as your web server
